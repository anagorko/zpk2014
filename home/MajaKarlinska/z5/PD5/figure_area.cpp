...
public:
    Point() : Point(0.0, 0.0) { //konstruktor domyslny, ustawia x i y na 0
    }
    Point(double _x, double _y) {
        x = _x; y = _y;
    }

    virtual double area() { //bez 0, oznacza to zatem, ze bedzie zadeklarowana
        return 0;
    }
...
int main(int argc, char ** argv)
{
    ...
    Figure* h = new Circle(Point(8.00, 12.00), 5.0);
