...
int main(int argc, char** argv){
   ...
   //wyswietlanie tekstu- font - wybieramy czcionke (zaladowana wyzej al_load_tlf....); kolor, miejsce, punkt
   //polozenia (centre/left/right; tekst kroey sie wypisze)
   //aby to dzialalo trrzeba dolozyc odpowiednie biblioteki a pozniej je zainicjowac
