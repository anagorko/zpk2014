...
int main(int, char**)
{
    ...
    al_stop_timer(timer); // al_stop_timer zatrzymuje dzia³anie timera
    float game_time = al_get_timer_count(timer) / FPS; // przypisanie zmiennej game_time , al_get_timer_count zwraca nalicozny czas
    cout << "GAME OVER!" << endl << "Your score: " << game_time << " seconds!" << endl; // wypisanie na ekranie czasu
