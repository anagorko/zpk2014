...
int main(int, char**)
{
    ...
    int64_t czas_gry = al_get_timer_count(timer)/60;
    cout << "GAME OVER" <<", czyli ..." << endl << endl;
    cout << "GRA SIE ZAKONCZYLA :(" << endl << endl << "Udalo Ci sie przetrwac "  << czas_gry <<" sekund." << endl<< endl<< endl<< endl << endl;
