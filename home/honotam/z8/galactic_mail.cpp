...
const int screen_e_w = 400;
const int screen_e_h = 400;
...
int main(int, char**)
{
    ...
    while (true)
    {
        ...
        if (coll > 1)
        {
            ALLEGRO_DISPLAY *close_window = al_create_display(screen_e_w, screen_e_h);
            al_register_event_source(event_queue, al_get_display_event_source(close_window));
    ...
    cout << "!!! GAME OVER !!!" << endl;
    cout << "elapsed time: " << setprecision(2) << game_time << " seconds" << endl;
    return 0;
}
